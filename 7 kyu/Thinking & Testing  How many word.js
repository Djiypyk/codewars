...
// <a href="http://www.codewars.com/kata/56c85eebfd8fc02551000281">Play Tetris : Shape anastomosis</a><br></br>
...
function testit(s) {
  ...
  for (let i = 0; i < s.length; i++) {
    if ((s[i] === "w" || s[i] === "W") && count1 === 0) {
      count1++;
      count2 += 0.25;
    } else if ((s[i] === "o" || s[i] === "O") && count1 === 1) {
      count1++;
      count2 += 0.25;
    } else if ((s[i] === "r" || s[i] === "R") && count1 === 2) {
      count1++;
      count2 += 0.25;
    } else if ((s[i] === "d" || s[i] === "D") && count1 === 3) {
      count1 = 0;
      count2 += 0.25;
    }
  }
